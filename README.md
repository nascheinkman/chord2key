...
The repo comes with configurations for four devices: 
- [Nintendo Switch Pro Controller](https://github.com/nascheinkman/chord2key/wiki/Default-Nintendo-Pro-Controller-Configuration)
- [Nintendo Switch Combined Joy-Cons](https://github.com/nascheinkman/chord2key/wiki/Default-Joycon-Configuration)
- [Nintendo Switch Left Joy-Con](https://github.com/nascheinkman/chord2key/wiki/Default-Left-Joycon-Configuration)
- [Nintendo Switch Right Joy-Con](https://github.com/nascheinkman/chord2key/wiki/Default-Right-Joycon-Configuration)

All require the [dkms-hid-nintendo](https://github.com/nicman23/dkms-hid-nintendo) kernel module, and the
joycons require the [joycond](https://github.com/DanielOgorchock/joycond) daemon. You could then
